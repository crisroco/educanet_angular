...
export class CourseManagementComponent implements OnInit {
	...
	goMoodle(course){
		...
		if(this.cod_company == '002' && (course['STRM'] == '1072' || course['STRM'] == '1073' || course['STRM'] == '1117' || course['STRM'] == '1118' || course['STRM'] == '1156' || course['STRM'] == '1157' || course['STRM'] == '2220' || course['STRM'] == '2222' || course['STRM'] == '2225' || course['STRM'] == '2235' || course['STRM'] == '2237' || course['STRM'] == '2238')){
